    ...
    return (
        <>
            <Swiper
                ...
                className="mySwiper lg:h-[600px] rounded-2xl"
            >
                ...
                <div className="text-center absolute -top-[12px] banner py-20 lg:py-56 my-3 rounded-xl castoro h-full w-full">
                    <h2 className='font-bold relative text-5xl hidden lg:block text-white z-30 '>Take the best that exists and <br /> make it better</h2>
                    <h5 className='font-bold relative text-2xl block lg:hidden text-white z-30 '>Take the best that exists and <br /> make it better</h5>
                    <Link to='/our-cars/1'><button className='btn bg-white text-black hover:bg-black hover:text-white border-none banner-btn lg:mt-5 z-30 relative rounded-full work-sans font-medium px-12'>Discover Now<FaArrowRight className='icon transition-[.9s] ml-1' /></button></Link>
                </div>
            </Swiper>
            <Car />
            <Qna />
